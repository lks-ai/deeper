 ...
 * and basic commands (e.g. \sin, \cos, \alpha, \times, \text, etc.).
 *
 * Usage:
 ...
 *
 * (c) 2025 LoreKeeper Ltd. All rights reserved.
 */
...
(function (root, factory) {
    ...
    // Mapping for common commands to UTF‑8 symbols.
    var greekMapping = {
    ...
    function parseExpression(tokens) {
      var nodes = [];
      // Stop on closing brace or \right token (end of scalable group).
    ...
    function parseAtom(tokens) {
      ...
      // Process optional superscript or subscript.
    ...
    function parseScalableGroup(tokens) {
      // Skip any whitespace after \left.
    ...
    function renderNode(node) {
      ...
      switch (node.type) {
        ...
        case "command":
          ...
          } else if (greekMapping[node.value] !== undefined) {
        ...
        case "scalable":
          ...
          break;
        case "textmode":
          // Render content of \text with a dedicated CSS class.
